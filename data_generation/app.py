from _tabbedinterface import TabbedInterface
from apps.chat_app import app as chat_app
from apps.instruct_app import app as instruct_app
from apps.rag_app import app as rag_app
...
def main():
    demo = TabbedInterface(
        [instruct_app, rag_app, chat_app],
        ["Instruct Data Generation", "RAG Data Generation", "Chat Data Generation"],
        css=css,
        title=image,
        theme=theme,
    )
